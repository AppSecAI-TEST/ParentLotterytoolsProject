...
<div style=" position:absolute; z-index:100000; height:2046px;top:0px;left:0px; width:100%; background:white; text-align:center;">
    ...
    <div region="north" split="false" border="false" style="overflow: hidden; height: 50px;
        ...
        <span style="padding-left:10px; font-size: 36px; float:left;font-family:隶书;">彩民工具数据管理平台</span>
    </div>
...
<div id='wnav' class="easyui-accordion" fit="true" border="false">
    ...
    <div id="mainPanle" region="center" style="background: #eee; overflow-y:hidden;">
        <div id="tabs" class="easyui-tabs"  fit="true" border="false" >
			...
			<div style="font-size:70px;text-align: center;  border-radius: 30px;color: deepskyblue;font-family: 隶书;width: 55%;margin-left:auto;margin-right:auto;    position: relative;    top: 30%;">欢迎进入佰艺霖彩民工具平台</div>
    ...
    <div id="w" class="easyui-window" title="修改密码" collapsible="false" minimizable="false"
        ...
        <div class="easyui-layout" fit="true">
            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
                <form id="updatePasswordForm" action="<%=request.getContextPath() %>/user/updatePassword.action" method="post">
                <table cellpadding=3>
                    <tr>
                        <td>新密码：</td>
                        <td><input class="easyui-validatebox textbox" type="password" id="password" name="password" data-options="required:true" validType="length[6,60]"   ></input></td>
                    </tr>
                    <tr>
                        <td>确认密码：</td>
