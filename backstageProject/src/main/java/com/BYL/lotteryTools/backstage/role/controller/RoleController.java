package com.BYL.lotteryTools.backstage.role.controller;
...
import com.BYL.lotteryTools.backstage.role.dto.RoleAuthBean;
...
//			   role.setStatus(status);
			   role.setCreator(LoginUtils.getAuthenticatedUserCode(httpSession));
	 ...
	 * @date 2015年10月19日 下午4:29:17
	 ...
	 @RequestMapping(value = "/manageRoleAndauth", method = RequestMethod.POST)
				...
				ModelMap model,HttpSession httpSession) throws Exception
		{
			...
			{
				Authority authority = authService.getAuthorityById(authId);
