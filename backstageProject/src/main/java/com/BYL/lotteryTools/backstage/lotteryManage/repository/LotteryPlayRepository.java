...
public interface LotteryPlayRepository extends GenericRepository<LotteryPlay, String> {
	...
	@Query("select u from LotteryPlay u where u.isDeleted='1' and  u.province =?1 and u.lotteryType =?2 and u.lotteryNumber =?3")
	...
	@Query("select u from LotteryPlay u where u.isDeleted='1' and  u.province =?1")
